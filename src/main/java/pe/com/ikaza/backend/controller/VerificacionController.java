...
public class VerificacionController {
    ...
    /**
     * POST /api/verification/phone/enviar
     * Enviar código de verificación por SMS
     */
    @PostMapping("/telefono/enviar")
    ...
    /**
     * POST /api/verification/telefono/verificar
     * Verificar código de teléfono
     */
    @PostMapping("/telefono/verificar")
    ...
    /**
     * GET /api/verification/telefono/estado/{email}
     * Verificar estado de teléfono
     */
    @GetMapping("/telefono/estado/{email}")
